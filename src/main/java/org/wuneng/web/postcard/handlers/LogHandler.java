...
public class LogHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        System.out.println("LogHandler channelRead");
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        System.out.println("LogHandler channelInactive");
            ...
            if (friends_ids.isSuccess()) {
                ...
                for (Integer i : friends) {
                    ...
                    if (channel != null) {
                        ...
                        System.out.println(log_out.getSubject());
                        System.out.println(log_out.getSendUserId());
