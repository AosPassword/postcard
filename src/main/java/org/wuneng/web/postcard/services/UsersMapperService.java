...
public interface UsersMapperService {
    ...
    Integer change_password(int parseInt, String password,String slat);

    String get_stu_id_by_phone_number(long phone_number);

    String get_salt_by_id(Integer id);

    String get_password_by_id(int parseInt);

    Integer change_password_by_phone(String phone_number, String new_password, String slat);
